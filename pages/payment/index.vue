<template>
  <div class="min-h-screen bg-gray-50">
      ...
      <div class="max-w-7xl mx-auto px-4 py-3">
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-3">
            <span class="font-medium">{{ bookingData.fromLabel || 'Siem Reap' }}</span>
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"/>
            </svg>
            <span class="font-medium">{{ bookingData.toLabel || 'Phnom Penh' }}</span>
          </div>
    ...
    <div class="max-w-7xl mx-auto p-4">
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div class="space-y-4">
                ...
                <label class="flex items-center p-4 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50">
                  ...
                  <div class="ml-3 flex-1 flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-2">
                      ...
                      <img src="/?height=24&width=38" alt="Mastercard" class="h-6" />
                      <img src="/?height=24&width=38" alt="UnionPay" class="h-6" />
                ...
                <label class="flex items-center p-4 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50">
                  ...
                  <div class="ml-3 flex-1 flex items-center justify-between">
                    ...
                    <span class="bg-red-500 text-white text-xs px-2 py-1 rounded font-medium">KHQR</span>
                  </div>
                </label>
                <!-- ACLEDA Bank -->
                <label class="flex items-center p-4 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50">
                  ...
                  <div class="ml-3 flex-1 flex items-center justify-between">
                    ...
                    <span class="bg-green-500 text-white text-xs px-2 py-1 rounded font-medium">-5</span>
                  </div>
                </label>
              </div>
              <!-- Pay Button -->
              ...
              <div class="bg-white rounded-lg shadow-sm overflow-hidden sticky top-4">
                ...
                <div class="flex border-b">
                  <button
                    ...
                    :class="activeTab === 'onward' ? 'bg-red-50 text-red-600 border-b-2 border-red-500' : 'text-gray-600 hover:text-gray-800'"
                  ...
                  <button
                    ...
                    :class="activeTab === 'return' ? 'bg-red-50 text-red-600 border-b-2 border-red-500' : 'text-gray-600 hover:text-gray-800'"
                    class="flex-1 px-4 py-3 text-sm font-medium transition-colors"
                  >
                    Return Trip
                  </button>
                ...
                <div class="p-4">
                  <!-- Operator -->
                  <div class="mb-4">
                    <h3 class="font-semibold text-red-500 text-lg">{{ bookingData.operator || 'Vireak Buntham Express' }}</h3>
                    <p class="text-sm text-gray-600">{{ bookingData.busType || 'Hotel Bus (Night Bus)' }}</p>
                  </div>
                  <!-- Departure Info -->
                  <div class="mb-4">
                    ...
                    <div class="flex items-center justify-between">
                      <span class="text-gray-800">{{ formatDate(bookingData.departureDate) }}</span>
                      <span class="font-medium">{{ bookingData.departureTime || '01:00' }}</span>
                    </div>
                  ...
                  <div class="mb-4">
                    <div class="flex items-center gap-2 mb-1">
                      ...
                      <span class="font-medium text-gray-800">Boarding Point</span>
                    </div>
                  ...
                  <div class="mb-4">
                    <div class="flex items-center gap-2 mb-1">
                      ...
                      <span class="font-medium text-gray-800">Dropping Point</span>
                    </div>
                    <p class="text-sm text-gray-600 ml-6">
                  ...
                  <div class="mb-4">
                    <div class="flex items-center gap-2 mb-1">
                      ...
                      <span class="font-medium text-gray-800">{{ getPassengerInfo() }}</span>
                    </div>
                  </div>
                  <!-- Fare Breakdown -->
                  <div class="border-t pt-4">
                    ...
                    >
                      <span class="font-medium text-gray-800">FARE BREAKUP</span>
                      <svg
                    ...
                    <div v-if="showFareBreakdown" class="space-y-2 mb-4">
                      <div class="flex items-center justify-between text-sm">
                        ...
                        <span class="font-medium">USD {{ getOnwardFare() }}</span>
                      </div>
                      <div v-if="isRoundTrip" class="flex items-center justify-between text-sm">
                        <span class="text-gray-600">Return Fare</span>
                        <span class="font-medium">USD {{ getReturnFare() }}</span>
                      </div>
                    </div>
                    <div class="flex items-center justify-between mb-2">
                      <span class="font-semibold text-gray-800">Total Payable</span>
                      <span class="font-bold text-lg">USD {{ getTotalPayable() }}</span>
                    </div>
                    <div class="bg-green-100 border border-green-200 rounded p-2">
                      <div class="flex items-center justify-between">
                        <span class="font-medium text-green-800">Total Discount</span>
                        <span class="font-bold text-green-800">USD {{ getDiscount() }}</span>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div class="flex items-center justify-center gap-6 mt-6">
          <img src="/?height=40&width=80" alt="MasterCard SecureCode" class="h-10" />
    ...
    <div v-if="showCardModal" class="fixed inset-0 bg-opacity-50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          ...
          <form @submit.prevent="submitCardPayment">
            ...
            <div class="bg-gray-50 p-4 rounded-lg mb-6">
              <div class="flex items-center justify-between">
                ...
                <span class="font-bold text-xl text-red-500">USD {{ getTotalPayable() }}</span>
              </div>
            </div>
    ...
    <div v-if="showQRModal" class="fixed inset-0 bg-opacity-50 backdrop-blur-sm  flex items-center justify-center z-50 p-4">
      <div class="bg-white rounded-lg shadow-xl max-w-md w-full">
        <div class="p-6 text-center">
          <div class="flex items-center justify-between mb-6">
            <h3 class="text-xl font-semibold text-gray-800">
              {{ selectedPaymentMethod === 'aba' ? 'ABA KHQR Payment' : 'ACLEDA  Payment' }}
            </h3>
            <button @click="closeModal" class="text-gray-400 hover:text-gray-600">
              <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
          ...
          <div class="mb-6">
            <p class="text-sm text-gray-600 mb-2">
              Scan this QR code with your {{ selectedPaymentMethod === 'aba' ? 'ABA Mobile' : 'ACLEDA ' }} app
            </p>
    ...
    <div v-if="showSuccessModal" class="fixed inset-0  bg-opacity-50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div class="bg-white rounded-lg shadow-xl max-w-md w-full">
        <div class="p-6 text-center">
          <!-- Success Icon -->
          ...
          <div class="bg-gray-50 p-4 rounded-lg mb-6">
            ...
            <p class="font-bold text-lg text-gray-800">{{ bookingReference }}</p>
          </div>
...
const getCurrentBoardingPoint = () => {
  if (activeTab.value === 'onward') {
    return `${bookingData.value.fromLabel || 'Phnom Penh'} (Cannon Rifle Roundabout Park)`
  } else {
...
const getOnwardFare = () => {
  return isRoundTrip.value ? bookingData.value.outboundTotal || '14.4' : bookingData.value.totalAmount || '14.4'
}
...
const getTotalPayable = () => {
  return bookingData.value.grandTotal || bookingData.value.totalAmount || '31.4'
}
...
const processPayment = () => {
  ...
  } else if (selectedPaymentMethod.value === 'aba' || selectedPaymentMethod.value === 'ACLEDA ') {
...
const submitCardPayment = async () => {
  ...
  bookingReference.value = 'BUS' + Math.random().toString(36).substr(2, 9).toUpperCase()
